 ...
 * rename the js file.
 * --------------------------Latest Version------------------------------------
 * Hi all, this latest version adds a function to get the controller brand,
 * such as xbox or playstation. This will be used in future [CGMZ] updates to
 * help show different things depending on the player's controller. For
 * example, you may want to show an A button icon to xbox controller users but
 * an X button icon to playstation controller users.
 *
 * Version 1.34.0
...
var CGMZ = {};
CGMZ.Versions = {};
CGMZ.Versions["CGMZ Core"] = "1.34.0";
CGMZ.Core = {};
